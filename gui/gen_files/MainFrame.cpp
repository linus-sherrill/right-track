    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    FileMenu->Append(wxID_ANY, wxT("Merge events"), wxT("Merge events into current data set."), wxITEM_NORMAL);
    FileMenu->Append(wxID_SAVE, wxT("Save"), wxT("Save dataset"), wxITEM_NORMAL);
    FileMenu->Append(wxID_SAVEAS, wxT("Save As..."), wxT("Save data set under a new name"), wxITEM_NORMAL);
    ...
    EditMenu->Append(EventSearch_id, wxT("Search"), wxT("Search for event names"), wxITEM_NORMAL);
    ...
    ViewMenu_sub->Append(SortEventName_id, wxT("Event Name"), wxEmptyString, wxITEM_NORMAL);
    ViewMenu_sub->Append(SortNumOccur_id, wxT("Num Occurrences"), wxEmptyString, wxITEM_NORMAL);
    ViewMenu_sub->Append(SortAvg_id, wxT("Average Duration"), wxEmptyString, wxITEM_NORMAL);
    ViewMenu_sub->Append(SortMaxDuration_id, wxT("Max Duration"), wxEmptyString, wxITEM_NORMAL);
    ViewMenu_sub->Append(SortMinDuration_id, wxT("Min Duration"), wxEmptyString, wxITEM_NORMAL);
    ViewMenu_sub->Append(SortPctAct_id, wxT("Percent Active"), wxEmptyString, wxITEM_NORMAL);
...
BEGIN_EVENT_TABLE(MainFrame, wxFrame)
    ...
    EVT_MENU(wxID_SAVE, MainFrame::SaveHandler)
    EVT_MENU(wxID_SAVEAS, MainFrame::SaveAsHandler)
    ...
    EVT_MENU(SortEventName_id, MainFrame::SortEventNameHandler)
    EVT_MENU(SortNumOccur_id, MainFrame::SortNumOccurHandler)
    EVT_MENU(SortAvg_id, MainFrame::SortAvgHandler)
    EVT_MENU(SortMaxDuration_id, MainFrame::SortMaxDurationHandler)
    EVT_MENU(SortMinDuration_id, MainFrame::SortMinDurationHandler)
    EVT_MENU(SortPctAct_id, MainFrame::SortPctActHandler)
...
void MainFrame::SaveHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SaveHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SaveAsHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SaveAsHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
...
void MainFrame::SortEventNameHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortEventNameHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SortNumOccurHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortNumOccurHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SortAvgHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortAvgHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SortMaxDurationHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortMaxDurationHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SortMinDurationHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortMinDurationHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void MainFrame::SortPctActHandler(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (MainFrame::SortPctActHandler) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
