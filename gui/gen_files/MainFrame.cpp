    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    g_EventNames = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxDOUBLE_BORDER);
    ...
    g_EndTime = new wxStaticText(this, wxID_ANY, wxEmptyString);
...
void MainFrame::set_properties()
{
    ...
    g_EventNames->SetMinSize(wxSize(150, 600));
    g_StartTime->SetBackgroundColour(wxColour(219, 219, 112));
    g_StartTime->SetFont(wxFont(9, wxDEFAULT, wxNORMAL, wxNORMAL, 0, wxT("")));
    g_EndTime->SetBackgroundColour(wxColour(219, 219, 112));
    g_EndTime->SetFont(wxFont(9, wxDEFAULT, wxNORMAL, wxNORMAL, 0, wxT("")));
...
void MainFrame::do_layout()
{
    ...
    sizer_3->Add(g_EventNames, 0, wxALL|wxEXPAND, 3);
    sizer_4->Add(g_EventFrame, 1, wxALL|wxEXPAND, 3);
    sizer_5->Add(g_StartTime, 0, wxEXPAND, 0);
    sizer_5->Add(g_timeScale, 1, wxEXPAND, 0);
    sizer_5->Add(g_EndTime, 0, wxEXPAND, 0);
