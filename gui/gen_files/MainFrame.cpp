    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    g_Curs1Time = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER);
    ...
    g_Curs2Time = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER);
...
BEGIN_EVENT_TABLE(MainFrame, wxFrame)
    ...
    EVT_TEXT_ENTER(wxID_ANY, MainFrame::Curs1Set)
    EVT_SPIN_DOWN(spin_1_id, MainFrame::Curs1Down)
    EVT_SPIN_UP(spin_1_id, MainFrame::Curs1Up)
    EVT_TEXT_ENTER(wxID_ANY, MainFrame::Curs2Set)
